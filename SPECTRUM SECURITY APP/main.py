...
####################################################
from db import DB
from antivirus import ScanVirusAll
...
class SystemTrayIcon(QtWidgets.QSystemTrayIcon):
	...
	def __init__(self, icon, parent=None):
		...
		self.setToolTip(f'БЫСТРЫЙ ЗАПУСК')
		menu = QtWidgets.QMenu(parent)

		menu.addAction(QtGui.QIcon("icons/exit.png"), "Открыть", lambda: parent.show())
